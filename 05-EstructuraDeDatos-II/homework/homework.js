...
LinkedList.prototype.remove = function(){
  ...
  let itemDel = this.head;

  while(current.next){
      //almacenando el penultimo node, para poder eliminar el ultimo
    itemDel = current;
...
HashTable.prototype.get = function(clave){
  ...
  return this.buckets[posicion][clave];
...
HashTable.prototype.hasKey = function(clave){
  ...
  return this.buckets[posicion].hasOwnProperty(clave);
